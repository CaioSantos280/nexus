...
// Adicionamos a tipagem para o componente receber a função de iniciar
...
export default function TodayWorkout({ onStart }: TodayWorkoutProps) {
  return (
    <section className="mt-10 mb-10">
      <div className="mb-6 flex items-end justify-between px-1">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onStart} // Aqui a mágica acontece
          className="flex items-center gap-2 rounded-2xl bg-[#ff7a00] px-6 py-4 font-black text-black shadow-[0_10px_20px_-5px_rgba(255,122,0,0.4)] transition-all active:shadow-none"
        >
        ...
        {exercises.map((exercise, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg tracking-tight text-zinc-100">{exercise.name}</h3>
